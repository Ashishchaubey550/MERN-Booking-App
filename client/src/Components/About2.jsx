...
const About2 = () => {
  return (
    <div className='w-full items-center flex flex-col py-10 px-12 text-center'>
      <h1 className='text-[36px] font-bold text-[#1A1A1A]'>WHY CHOOSE US?</h1>
      <div className='flex mx-6 my-9'>
        <div className='flex flex-col items-center text-center mx-3 px-2'>
            <div className='bg-[#EBF9FF] w-[50px] h-[50px] flex items-center justify-center rounded-lg mb-3'><AiOutlineDollar color='#008EC4' fontSize='22px'/></div>
        ...
        <div className='flex flex-col items-center text-center mx-3 px-2'>
            <div className='bg-[#EBF9FF] w-[50px] h-[50px] flex items-center justify-center rounded-lg mb-3'><RiShieldUserLine color='#008EC4' fontSize='22px'/></div>
        ...
        <div className='flex flex-col items-center text-center mx-3 px-2'>
            <div className='bg-[#EBF9FF] w-[50px] h-[50px] flex items-center justify-center rounded-lg mb-3'><RiRestartLine color='#008EC4' fontSize='22px'/></div>
